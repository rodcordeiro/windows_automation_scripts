...
.AUTHOR Adam (https://github.com/adbertram/)
...
.PROJECTURI https://github.com/adbertram/Random-PowerShell-Work/blob/master/Random%20Stuff/Invoke-WindowsDiskCleanup.ps1
